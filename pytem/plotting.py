...
class TEMPlotter:
    """Convenience plotter for TEM soundings and resistivity models."""
    ...
    # Sounding
    # ------------------------------------------------------------------ #
    def plot_sounding(self, times, *curves, ax=None, labels=None,
        ...
        *curves: one or more (n_t,) arrays of **positive** -dB/dt values.
    ...
    # Resistivity model
    # ------------------------------------------------------------------ #
    def plot_model(self, thicknesses, resistivities, ax=None, label='Model',
                   color=None, depth_pad=10, xlim=None, title='Resistivity model',
                   linestyle='-'):
        ...
        """
        if ax is None:
            fig, ax = plt.subplots(figsize=(self.figsize[0] / 3, self.figsize[1]))
    ...
    # ------------------------------------------------------------------ #
    # Combined inversion result
    # ------------------------------------------------------------------ #
    def plot_inversion(self, times, obs_data, mod_data, thicknesses,
